...
contract('TokenSwap', ([appManager, user]) => {
  ...
  //   supply = new web3.BigNumber(100 * 10 ** 18);
  //   connectorBalance = new web3.BigNumber(9 * 10 ** 18);
  //   connectorWeight = 22959;
  //   depositAmount = new web3.BigNumber(100 * 10 ** 18); 
    
  //   await app.getPurchaseReturn(supply, connectorBalance, connectorWeight, depositAmount, { from: user })
  //   // await console.log(await app.balance());
  // })
